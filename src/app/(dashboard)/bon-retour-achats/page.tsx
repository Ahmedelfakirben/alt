...
import { useBonRetourAchatList, useDeleteBonRetourAchat, useUpdateBonRetourAchatStatut } from "@/hooks/use-bon-retour-achats"
...
export default function BonRetourAchatsPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <DataTable columns={columns} data={bras || []} searchPlaceholder="Rechercher un bon de retour achat..." createUrl="/bon-retour-achats/nouveau" createLabel="Nouveau BRA" />
        </div>
    )
}
