...
import { useBonAchatList, useDeleteBonAchat, useUpdateBonAchatStatut, useToggleBonAchatTVA } from "@/hooks/use-bon-achats"
                    ...
                    <div onClick={(e) => e.stopPropagation()}>
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem onClick={() => handleToggleTVA(ba.id, !!ba.inclure_tva)}>
                                    <FileText className="mr-2 h-4 w-4" />
                                    {ba.inclure_tva ? "Retirer TVA" : "Appliquer TVA"}
                                </DropdownMenuItem>
    ...
    return (
        <div className="space-y-6">
            ...
            <DataTable 
                columns={columns} 
                data={bas || []} 
                searchPlaceholder="Rechercher un bon d'achat..." 
