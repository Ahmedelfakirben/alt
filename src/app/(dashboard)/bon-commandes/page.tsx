...
import { useBonCommandeList, useDeleteBonCommande, useUpdateBonCommandeStatut } from "@/hooks/use-bon-commandes"
import { DataTable } from "@/components/data-table/data-table"
import type { BonCommande } from "@/types/database"
import { Button } from "@/components/ui/button"
import { Badge } from "@/components/ui/badge"
import { MoreHorizontal, Pencil, Trash2, Eye, CheckCircle, Send } from "lucide-react"
...
export default function BonCommandesPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <DataTable columns={columns} data={bcs || []} searchPlaceholder="Rechercher un bon de commande..." createUrl="/bon-commandes/nouveau" createLabel="Nouveau BC" />
        </div>
    )
}
