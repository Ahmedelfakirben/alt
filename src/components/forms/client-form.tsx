...
import { clientSchema, type ClientFormData } from "@/lib/validations/master-data"
...
export function ClientForm({ defaultValues, onSubmit, isLoading }: ClientFormProps) {
  ...
  const { data: nextCode, isLoading: isCodeLoading } = useNextCode("clients", "CLI")
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex gap-4">
          <Button type="submit" disabled={isLoading}>
            ...
            {defaultValues ? "Mettre à jour" : "Créer le client"}
          </Button>
